...
const Footer = () => {
  return (
    <div className='w-full flex gap-7 h-screen px-12 py-12 rounded-l-lg rounded-r-lg'>
      

      <div className='w-1/2 relative h-full '>
      <h1 className='text-[7rem] uppercase font-bold tracking-tighter leading-none -mb-[10]'>eye-opening
      </h1>
    
      <div className="logo absolute left-5 bottom-2">
            <svg
              width="72"
              height="30"
              viewBox="0 0 72 30"
      ...
      <h1 className='uppercase text-[6vw] font-bold leading-none tracking-tighter'>presentation</h1>
...
<a href='' className='underline'>Linkdin</a>


</ul>

<ul className='flex flex-col mt-5'>
    <p className='mb-4'>L:</p>
<a href='' className='underline'>202-1965 W 4th Ave</a>
<a href='' className='underline'>Vancouver, Canada</a>
<a href='' className='underline'>30 Chukarina St</a>
...
<ul className='flex flex-col mt-5'>
    <p className='mb-4'>L:</p>
<a href='' className='underline'>hello@farhan</a>
